...
// the deeper you are), faster still when you crawl; sustained top speed + clean
// near-miss evasion drain it. Clip traffic and it spikes; clip a cop spikes hard.
// Fill it and you're BUSTED. Drain it to zero and you've SHAKEN them: bank a
// bounty and lie low until another cruiser spots you and the chase resumes.
export const BUST_RISE = 0.0013;       // base fill / frame while a chase is active
...
export const BUST_FAST_DRAIN = 0.0024; // drain at high speed (> 80%): a real net drain, so
                                       // sustained flat-out actually pulls you away from them
...
export const BUST_GRACE = 150;         // frames before the first cruiser spots you (~2.5s)
export const BUST_SEED = 0.32;         // meter value when a fresh chase begins (cops on you)
export const BUST_BOUNTY = 500;        // base score reward for shaking a chase (grows per escape)
export const PURSUIT_LULL = 300;       // base frames laying low after an escape (~5s)
export const PURSUIT_LULL_RAND = 150;  // up to this many extra random frames of calm (~+2.5s)
